...
func (j *jsiiProxy_DataHcpHvnRouteAzureConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataHcpHvnRouteAzureConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataHcpHvnRouteAzureConfigList {
	_init_.Initialize()
...
func NewDataHcpHvnRouteAzureConfigList_Override(d DataHcpHvnRouteAzureConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataHcpHvnRouteAzureConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataHcpHvnRouteAzureConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataHcpHvnRouteAzureConfigList) Resolve(context cdktn.IResolveContext) interface{} {
