...
func (j *jsiiProxy_DataHcpWaypointAddOnDefinition) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataHcpWaypointAddOnDefinition) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataHcpWaypointAddOnDefinition) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataHcpWaypointAddOnDefinition) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataHcpWaypointAddOnDefinition) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataHcpWaypointAddOnDefinition(scope constructs.Construct, id *string, config *DataHcpWaypointAddOnDefinitionConfig) DataHcpWaypointAddOnDefinition {
	...
	_jsii_.Create(
		"@cdktn/provider-hcp.dataHcpWaypointAddOnDefinition.DataHcpWaypointAddOnDefinition",
...
func (j *jsiiProxy_DataHcpWaypointAddOnDefinition)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataHcpWaypointAddOnDefinition)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataHcpWaypointAddOnDefinition)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataHcpWaypointAddOnDefinition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataHcpWaypointAddOnDefinition) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataHcpWaypointAddOnDefinition) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
