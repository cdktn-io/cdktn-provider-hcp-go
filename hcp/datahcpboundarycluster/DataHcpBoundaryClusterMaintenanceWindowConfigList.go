...
func (j *jsiiProxy_DataHcpBoundaryClusterMaintenanceWindowConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataHcpBoundaryClusterMaintenanceWindowConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataHcpBoundaryClusterMaintenanceWindowConfigList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-hcp.dataHcpBoundaryCluster.DataHcpBoundaryClusterMaintenanceWindowConfigList",
...
func NewDataHcpBoundaryClusterMaintenanceWindowConfigList_Override(d DataHcpBoundaryClusterMaintenanceWindowConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataHcpBoundaryClusterMaintenanceWindowConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataHcpBoundaryClusterMaintenanceWindowConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataHcpBoundaryClusterMaintenanceWindowConfigList) Resolve(context cdktn.IResolveContext) interface{} {
