...
func (j *jsiiProxy_PrivateLink) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_PrivateLink) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_PrivateLink) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PrivateLink) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_PrivateLink) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func NewPrivateLink(scope constructs.Construct, id *string, config *PrivateLinkConfig) PrivateLink {
	...
	_jsii_.Create(
		"@cdktf/provider-hcp.privateLink.PrivateLink",
...
func (j *jsiiProxy_PrivateLink)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PrivateLink)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PrivateLink)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PrivateLink_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PrivateLink) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PrivateLink) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PrivateLink) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
