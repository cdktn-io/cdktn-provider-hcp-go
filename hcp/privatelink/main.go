...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PrivateLink)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "consumerAccountsInput", GoGetter: "ConsumerAccountsInput"},
			_jsii_.MemberProperty{JsiiProperty: "consumerIpRanges", GoGetter: "ConsumerIpRanges"},
			_jsii_.MemberProperty{JsiiProperty: "consumerIpRangesInput", GoGetter: "ConsumerIpRangesInput"},
			_jsii_.MemberProperty{JsiiProperty: "consumerRegions", GoGetter: "ConsumerRegions"},
			_jsii_.MemberProperty{JsiiProperty: "consumerRegionsInput", GoGetter: "ConsumerRegionsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetConsumerAccounts", GoMethod: "ResetConsumerAccounts"},
			_jsii_.MemberMethod{JsiiMethod: "resetConsumerIpRanges", GoMethod: "ResetConsumerIpRanges"},
			_jsii_.MemberMethod{JsiiMethod: "resetConsumerRegions", GoMethod: "ResetConsumerRegions"},
			...
			_jsii_.MemberProperty{JsiiProperty: "vaultClusterIdInput", GoGetter: "VaultClusterIdInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.privateLink.PrivateLinkConfig",
		reflect.TypeOf((*PrivateLinkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.privateLink.PrivateLinkTimeouts",
		reflect.TypeOf((*PrivateLinkTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-hcp.privateLink.PrivateLinkTimeoutsOutputReference",
		reflect.TypeOf((*PrivateLinkTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
