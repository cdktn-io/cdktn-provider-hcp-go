...
import (
	...
	"github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v11/datahcpuserprincipal/internal"
...
func (j *jsiiProxy_DataHcpUserPrincipal) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataHcpUserPrincipal) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataHcpUserPrincipal) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataHcpUserPrincipal) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataHcpUserPrincipal) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataHcpUserPrincipal(scope constructs.Construct, id *string, config *DataHcpUserPrincipalConfig) DataHcpUserPrincipal {
	...
	_jsii_.Create(
		"@cdktn/provider-hcp.dataHcpUserPrincipal.DataHcpUserPrincipal",
...
func (j *jsiiProxy_DataHcpUserPrincipal)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataHcpUserPrincipal)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataHcpUserPrincipal)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataHcpUserPrincipal_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataHcpUserPrincipal) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataHcpUserPrincipal) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
