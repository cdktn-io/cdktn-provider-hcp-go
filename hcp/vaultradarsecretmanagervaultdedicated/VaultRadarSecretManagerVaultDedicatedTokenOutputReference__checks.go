...
func (v *jsiiProxy_VaultRadarSecretManagerVaultDedicatedTokenOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_VaultRadarSecretManagerVaultDedicatedTokenOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *VaultRadarSecretManagerVaultDedicatedToken:
		val := val.(*VaultRadarSecretManagerVaultDedicatedToken)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case VaultRadarSecretManagerVaultDedicatedToken:
		val_ := val.(VaultRadarSecretManagerVaultDedicatedToken)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *VaultRadarSecretManagerVaultDedicatedToken; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_VaultRadarSecretManagerVaultDedicatedTokenOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewVaultRadarSecretManagerVaultDedicatedTokenOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) error {
