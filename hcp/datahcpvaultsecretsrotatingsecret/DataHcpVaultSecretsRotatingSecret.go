...
import (
	...
	"github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v11/datahcpvaultsecretsrotatingsecret/internal"
...
func (j *jsiiProxy_DataHcpVaultSecretsRotatingSecret) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataHcpVaultSecretsRotatingSecret) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataHcpVaultSecretsRotatingSecret) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataHcpVaultSecretsRotatingSecret) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataHcpVaultSecretsRotatingSecret) SecretValues() cdktn.StringMap {
...
func (j *jsiiProxy_DataHcpVaultSecretsRotatingSecret) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataHcpVaultSecretsRotatingSecret(scope constructs.Construct, id *string, config *DataHcpVaultSecretsRotatingSecretConfig) DataHcpVaultSecretsRotatingSecret {
	...
	_jsii_.Create(
		"@cdktn/provider-hcp.dataHcpVaultSecretsRotatingSecret.DataHcpVaultSecretsRotatingSecret",
...
func (j *jsiiProxy_DataHcpVaultSecretsRotatingSecret)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataHcpVaultSecretsRotatingSecret)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataHcpVaultSecretsRotatingSecret)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataHcpVaultSecretsRotatingSecret_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataHcpVaultSecretsRotatingSecret) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataHcpVaultSecretsRotatingSecret) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
