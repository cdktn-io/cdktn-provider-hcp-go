...
import (
	...
	"github.com/cdktn-io/cdktn-provider-hcp-go/hcp/v11/vaultsecretsappiampolicy/internal"
...
func (j *jsiiProxy_VaultSecretsAppIamPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VaultSecretsAppIamPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VaultSecretsAppIamPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VaultSecretsAppIamPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VaultSecretsAppIamPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_VaultSecretsAppIamPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VaultSecretsAppIamPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VaultSecretsAppIamPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VaultSecretsAppIamPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VaultSecretsAppIamPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VaultSecretsAppIamPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VaultSecretsAppIamPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
