...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "geography", GoGetter: "Geography"},
			_jsii_.MemberProperty{JsiiProperty: "geographyInput", GoGetter: "GeographyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetGeography", GoMethod: "ResetGeography"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-hcp.provider.HcpProviderConfig",
		reflect.TypeOf((*HcpProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-hcp.provider.HcpProviderWorkloadIdentity",
