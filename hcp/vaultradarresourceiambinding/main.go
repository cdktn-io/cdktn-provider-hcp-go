...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VaultRadarResourceIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-hcp.vaultRadarResourceIamBinding.VaultRadarResourceIamBindingConfig",
		reflect.TypeOf((*VaultRadarResourceIamBindingConfig)(nil)).Elem(),
	)
}
