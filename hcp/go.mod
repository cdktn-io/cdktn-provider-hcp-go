// Deprecated: HashiCorp is no longer publishing new versions of the prebuilt provider for hcp.
...
// You can continue to use the hcp provider in your CDK for Terraform projects with newer versions of CDKTF,
